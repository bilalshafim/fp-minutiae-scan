...
namespace FP_Engine.EngineInterface
{
    ...
    /// Since FP_Engine algorithm is not scale-invariant, all images should have DPI configured explicitly by setting <see cref="Dpi" />.
    /// </remarks>
    ...
    public class FingerprintImageOptions
    {
        ...
        /// <remarks>
        /// FP_Engine algorithm is not scale-invariant. Fingerprints with incorrectly configured DPI may fail to match.
